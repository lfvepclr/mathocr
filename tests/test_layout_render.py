...
class AdaptPageLabelTest(unittest.TestCase):
    ...
    def test_semantic_types_pass_through(self):
        result = engine_baidu._adapt_page(_page([
        ...
        self.assertEqual(_labels(result), [
            "vertical_text", "aside_text", "formula_number",
            "figure_title", "header", "abstract", "reference_content",
        ])
    ...
    def test_true_equivalents_mapped(self):
        ...
        self.assertEqual(_labels(result),
                         ["paragraph_title", "formula", "contents"])
    ...
    def test_image_types_without_data_url(self):
        ...
        self.assertEqual(_labels(result),
                         ["seal", "header_image", "footer_image"])
    ...
    def test_header_image_with_data_url(self):
        ...
        engine_baidu._download = lambda url: png
        try:
            result = engine_baidu._adapt_page(_page(
